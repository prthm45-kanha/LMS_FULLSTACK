...
const TestimonialSection = () => {
  return (
    <div className='pb-14 px-8 md:px-0'>
      <h2 className='text-3xl fonr-medium text-gray-800'>Testimonials</h2>
          ...
          pb-6 rounded-lg bg-white shadow-[0px_4px_15px_0px] shadow-black/5 overflow-hidden'>
            <div className='flex items-center gap-4 px-5 py-4 bg-gray-500/10'>
              ...
              <div>
                ...
                <p className='text-grsy-800/80'>{testimonial.role}</p>
              </div>
             ...
             <div className='p-5 pb-7'>
              ...
              <a className='text-blue-600 px-5 underline text-sm' href='#'>Read More</a>
