  ...
  return (
    <div>
        ...
        <p className='text-sm md:text-base text-gray-500 mt-3 '> Discover our top-rated 
          corses across various categories.From coding and design to business <br/> and
          wellness, our courses are crafted to deliver results. </p>
               <div className="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] px-4 md:px-0 md:my-10 gap-4">
